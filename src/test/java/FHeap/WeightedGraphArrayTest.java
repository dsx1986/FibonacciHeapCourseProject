...
/**
 * Test whether the WeightedGraph using Array as priority queue is successful
 */
public class WeightedGraphArrayTest {
    ...
    @Test
    public void testWeightedGraphArray() {
        ...
        WeightedGraphArray<String> graph1 = new WeightedGraphArray<String>(edges, vertices);
        ...
        WeightedGraphArray<String>.ShortestPathTree tree1
        ...
        WeightedGraphArray<Integer> graph2 = new WeightedGraphArray<Integer>(edges, 5);

        System.out.println("\nThe edges for graph2:");
        graph2.printWeightedEdges();

        WeightedGraphArray<Integer>.ShortestPathTree tree2
